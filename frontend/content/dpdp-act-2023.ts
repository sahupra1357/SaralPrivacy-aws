/**
 * Digital Personal Data Protection Act, 2023 — Structured Content
 * Source: Gazette of India Extraordinary, Part II — Section 1
 *         No. 22 of 2023, dated 11th August, 2023
 *
 * Official text extracted verbatim from the Presidential-assent Gazette publication.
 * Plain-English summaries and Key Takeaways are editorial additions by SaralPrivacy
 * for educational purposes only — they are not legal interpretations.
 *
 * Last verified: April 2026
 */

export type ActChapter = {
  ...
  sections: [
    {
      ...
      chapterNumber: 1,
      chapterTitle: "Preliminary",
      officialText: `(1) This Act may be called the Digital Personal Data Protection Act, 2023.
...
(2) It shall come into force on such date as the Central Government may, by notification in the Official Gazette, appoint and different dates may be appointed for different provisions of this Act and any reference in any such provision to the commencement of this Act shall be construed as a reference to the coming into force of that provision.`,
    ...
    },
    {
      ...
      chapterNumber: 1,
      chapterTitle: "Preliminary",
      officialText: `In this Act, unless the context otherwise requires,—
...
(zb) "State" means the State as defined under article 12 of the Constitution.`,
    ...
    },
    {
      ...
      chapterNumber: 1,
      chapterTitle: "Preliminary",
      officialText: `Subject to the provisions of this Act, it shall—
  ...
  sections: [
    {
      ...
      chapterNumber: 2,
      chapterTitle: "Obligations of Data Fiduciary",
      officialText: `(1) A person may process the personal data of a Data Principal only in accordance with the provisions of this Act and for a lawful purpose,—
...
(2) For the purposes of this section, the expression "lawful purpose" means any purpose which is not expressly forbidden by law.`,
    ...
    },
    {
      ...
      chapterNumber: 2,
      chapterTitle: "Obligations of Data Fiduciary",
      officialText: `(1) Every request made to a Data Principal under section 6 for consent shall be accompanied or preceded by a notice given by the Data Fiduciary to the Data Principal, informing her,—
...
(10) Where a consent given by the Data Principal is the basis of processing of personal data and a question arises in this regard in a proceeding, the Data Fiduciary shall be obliged to prove that a notice was given by her to the Data Principal and consent was given by such Data Principal to the Data Fiduciary in accordance with the provisions of this Act and the rules made thereunder.`,
    ...
    },
    {
      ...
      chapterNumber: 2,
      chapterTitle: "Obligations of Data Fiduciary",
      officialText: `A Data Fiduciary may process personal data of a Data Principal for any of following uses, namely:—
...
(i) for the purposes of employment or those related to safeguarding the employer from loss or liability, such as prevention of corporate espionage, maintenance of confidentiality of trade secrets, intellectual property, classified information or provision of any service or benefit sought by a Data Principal who is an employee.`,
    ...
    },
    {
      ...
      chapterNumber: 2,
      chapterTitle: "Obligations of Data Fiduciary",
      officialText: `(1) A Data Fiduciary shall, irrespective of any agreement to the contrary or failure of a Data Principal to carry out the duties provided under this Act, be responsible for complying with the provisions of this Act and the rules made thereunder in respect of any processing undertaken by it or on its behalf by a Data Processor.
...
(11) For the purposes of this section, it is hereby clarified that a Data Principal shall be considered as not having approached the Data Fiduciary for the performance of the specified purpose, in any period during which she has not initiated contact with the Data Fiduciary for such performance, in person or by way of communication in electronic or physical form.`,
    ...
    },
    {
      ...
      chapterNumber: 2,
      chapterTitle: "Obligations of Data Fiduciary",
      officialText: `(1) The Data Fiduciary shall, before processing any personal data of a child or a person with disability who has a lawful guardian obtain verifiable consent of the parent of such child or the lawful guardian, as the case may be, in such manner as may be prescribed.
...
(5) The Central Government may, if satisfied that a Data Fiduciary has ensured that its processing of personal data of children is done in a manner that is verifiably safe, notify for such processing by such Data Fiduciary the age above which that Data Fiduciary shall be exempt from the applicability of all or any of the obligations under sub-sections (1) and (3) in respect of processing by that Data Fiduciary as the notification may specify.`,
    ...
    },
    {
      ...
      chapterNumber: 2,
      chapterTitle: "Obligations of Data Fiduciary",
      officialText: `(1) The Central Government may notify any Data Fiduciary or class of Data Fiduciaries as Significant Data Fiduciary, on the basis of an assessment of such relevant factors as it may determine, including—
...
const chapter3: ActChapter = {
  chapterNumber: 3,
  chapterTitle: "Rights and Duties of Data Principal",
  sections: [
    {
      sectionNumber: 11,
      slug: "section-11",
...
(3) A Data Principal shall make a request in such manner as may be prescribed to the Data Fiduciary for erasure of her personal data, and upon receipt of such a request, the Data Fiduciary shall erase her personal data unless retention of the same is necessary for the specified purpose or for compliance with any law for the time being in force.`,
    ...
    },
    {
      ...
      chapterNumber: 3,
      chapterTitle: "Rights and Duties of Data Principal",
      officialText: `(1) A Data Principal shall have the right to have readily available means of grievance redressal provided by a Data Fiduciary or Consent Manager in respect of any act or omission of such Data Fiduciary or Consent Manager regarding the performance of its obligations in relation to the personal data of such Data Principal or the exercise of her rights under the provisions of this Act and the rules made thereunder.
...
(3) The Data Principal shall exhaust the opportunity of redressing her grievance under this section before approaching the Board.`,
    ...
    },
    {
      ...
      chapterNumber: 3,
      chapterTitle: "Rights and Duties of Data Principal",
      officialText: `(1) A Data Principal shall have the right to nominate, in such manner as may be prescribed, any other individual, who shall, in the event of death or incapacity of the Data Principal, exercise the rights of the Data Principal in accordance with the provisions of this Act and the rules made thereunder.
...
(2) For the purposes of this section, the expression "incapacity" means inability to exercise the rights of the Data Principal under the provisions of this Act or the rules made thereunder due to unsoundness of mind or infirmity of body.`,
    ...
    },
    {
      ...
      chapterNumber: 3,
      chapterTitle: "Rights and Duties of Data Principal",
      officialText: `A Data Principal shall perform the following duties, namely:—
...
const chapter4: ActChapter = {
  chapterNumber: 4,
  chapterTitle: "Special Provisions",
  sections: [
    {
      sectionNumber: 16,
      slug: "section-16",
      ...
      chapterNumber: 4,
      chapterTitle: "Special Provisions",
      officialText: `(1) The Central Government may, by notification, restrict the transfer of personal data by a Data Fiduciary for processing to such country or territory outside India as may be so notified.
...
(2) Nothing contained in this section shall restrict the applicability of any law for the time being in force in India that provides for a higher degree of protection for or restriction on transfer of personal data by a Data Fiduciary outside India in relation to any personal data or Data Fiduciary or class thereof.`,
    ...
    },
    {
      ...
      chapterNumber: 4,
      chapterTitle: "Special Provisions",
      officialText: `(1) The provisions of Chapter II, except sub-sections (1) and (5) of section 8, and those of Chapter III and section 16 shall not apply where—
...
const chapter5: ActChapter = {
  chapterNumber: 5,
  chapterTitle: "Data Protection Board of India",
  sections: [
    {
      sectionNumber: 18,
      slug: "section-18",
      ...
      chapterNumber: 5,
      chapterTitle: "Data Protection Board of India",
      officialText: `(1) With effect from such date as the Central Government may, by notification, appoint, there shall be established, for the purposes of this Act, a Board to be called the Data Protection Board of India.
...
(3) The headquarters of the Board shall be at such place as the Central Government may notify.`,
    },
    {
      ...
      chapterNumber: 5,
      chapterTitle: "Data Protection Board of India",
      officialText: `(1) The Board shall consist of a Chairperson and such number of other Members as the Central Government may notify.
...
(3) The Chairperson and other Members shall be a person of ability, integrity and standing who possesses special knowledge or practical experience in the fields of data governance, administration or implementation of laws related to social or consumer protection, dispute resolution, information and communication technology, digital economy, law, regulation or techno-regulation, or in any other field which in the opinion of the Central Government may be useful to the Board, and at least one among them shall be an expert in the field of law.`,
    },
    {
      ...
      chapterNumber: 5,
      chapterTitle: "Data Protection Board of India",
      officialText: `(1) The salary, allowances and other terms and conditions of service of the Chairperson and other Members shall be such as may be prescribed, and shall not be varied to their disadvantage after their appointment.
...
(2) The Chairperson and other Members shall hold office for a term of two years and shall be eligible for re-appointment.`,
    },
    {
      ...
      chapterNumber: 5,
      chapterTitle: "Data Protection Board of India",
      officialText: `(1) A person shall be disqualified for being appointed and continued as the Chairperson or a Member, if she—
...
(3) The Chairperson and any other Member shall not, for a period of one year from the date on which they cease to hold such office, except with the previous approval of the Central Government, accept any employment, and shall also disclose to the Central Government any subsequent acceptance of employment with any Data Fiduciary against whom proceedings were initiated by or before such Chairperson or other Member.`,
    },
    {
      ...
      chapterNumber: 5,
      chapterTitle: "Data Protection Board of India",
      officialText: `(1) The Board shall observe such procedure in regard to the holding of and transaction of business at its meetings, including by digital means, and authenticate its orders, directions and instruments in such manner as may be prescribed.
...
(3) When the Chairperson is unable to discharge her functions owing to absence, illness or any other cause, the senior-most Member shall discharge the functions of the Chairperson until the date on which the Chairperson resumes her duties.`,
    },
    {
      ...
      chapterNumber: 5,
      chapterTitle: "Data Protection Board of India",
      officialText: `The Board may, with previous approval of the Central Government, appoint such officers and employees as it may deem necessary for the efficient discharge of its functions under the provisions of this Act, on such terms and conditions of appointment and service as may be prescribed.`,
    },
    {
      sectionNumber: 25,
      slug: "section-25",
      ...
      chapterNumber: 5,
      chapterTitle: "Data Protection Board of India",
      officialText: `The Chairperson, Members, officers and employees of the Board shall be deemed, when acting or purporting to act in pursuance of provisions of this Act, to be public servants within the meaning of section 21 of the Indian Penal Code.`,
    },
    {
      sectionNumber: 26,
      slug: "section-26",
      ...
      chapterNumber: 5,
      chapterTitle: "Data Protection Board of India",
      officialText: `The Chairperson shall exercise the following powers, namely:—
...
const chapter6: ActChapter = {
  chapterNumber: 6,
  chapterTitle: "Powers, Functions and Procedure to be Followed by Board",
  sections: [
    {
      sectionNumber: 27,
      slug: "section-27",
      ...
      chapterNumber: 6,
      chapterTitle: "Powers, Functions and Procedure to be Followed by Board",
      officialText: `(1) The Board shall exercise and perform the following powers and functions, namely:—
...
const chapter7: ActChapter = {
  chapterNumber: 7,
  chapterTitle: "Appeal and Alternate Dispute Resolution",
  sections: [
    {
      sectionNumber: 29,
      slug: "section-29",
      ...
      chapterNumber: 7,
      chapterTitle: "Appeal and Alternate Dispute Resolution",
      officialText: `(1) Any person aggrieved by an order or direction made by the Board under this Act may prefer an appeal before the Appellate Tribunal.
...
(10) In respect of appeals filed under the provisions of this Act, the Appellate Tribunal shall, as far as practicable, function as a digital office, with the receipt of appeal, hearing and pronouncement of decisions in respect of the same being digital by design.`,
    },
    {
      ...
      chapterNumber: 7,
      chapterTitle: "Appeal and Alternate Dispute Resolution",
      officialText: `(1) An order passed by the Appellate Tribunal under this Act shall be executable by it as a decree of civil court, and for this purpose, the Appellate Tribunal shall have all the powers of a civil court.
...
(2) Notwithstanding anything contained in sub-section (1), the Appellate Tribunal may transmit any order made by it to a civil court having local jurisdiction and such civil court shall execute the order as if it were a decree made by that court.`,
    ...
    },
    {
      ...
      chapterNumber: 7,
      chapterTitle: "Appeal and Alternate Dispute Resolution",
      officialText: `(1) The Board may accept a voluntary undertaking in respect of any matter related to observance of the provisions of this Act from any person at any stage of a proceeding under section 28.
...
const chapter8: ActChapter = {
  chapterNumber: 8,
  chapterTitle: "Penalties and Adjudication",
  sections: [
    {
      sectionNumber: 33,
      slug: "section-33",
      ...
      chapterNumber: 8,
      chapterTitle: "Penalties and Adjudication",
      officialText: `(1) If the Board determines on conclusion of an inquiry that breach of the provisions of this Act or the rules made thereunder by a person is significant, it may, after giving the person an opportunity of being heard, impose such monetary penalty specified in the Schedule.
...
(2) While determining the amount of monetary penalty to be imposed under sub-section (1), the Board shall have regard to the following matters, namely:—
    ...
    },
    {
      ...
      chapterNumber: 8,
      chapterTitle: "Penalties and Adjudication",
      officialText: `All sums realised by way of penalties imposed by the Board under this Act, shall be credited to the Consolidated Fund of India.`,
      plainEnglish:
  ...
  sections: [
    {
      ...
      chapterNumber: 9,
      chapterTitle: "Miscellaneous",
      officialText: `No suit, prosecution or other legal proceedings shall lie against the Central Government, the Board, its Chairperson and any Member, officer or employee thereof for anything which is done or intended to be done in good faith under the provisions of this Act or the rules made thereunder.`,
    },
    {
      sectionNumber: 36,
      slug: "section-36",
      ...
      chapterNumber: 9,
      chapterTitle: "Miscellaneous",
      officialText: `The Central Government may, for the purposes of this Act, require the Board and any Data Fiduciary or intermediary to furnish such information as it may call for.`,
    },
    {
      sectionNumber: 37,
      slug: "section-37",
      ...
      chapterNumber: 9,
      chapterTitle: "Miscellaneous",
      officialText: `(1) The Central Government or any of its officers specially authorised by it in this behalf may, upon receipt of a reference in writing from the Board that—
...
(3) For the purposes of this section, the expressions "computer resource", "information" and "intermediary" shall have the meanings respectively assigned to them in the Information Technology Act, 2000.`,
    ...
    },
    {
      ...
      chapterNumber: 9,
      chapterTitle: "Miscellaneous",
      officialText: `(1) The provisions of this Act shall be in addition to and not in derogation of any other law for the time being in force.
...
(2) In the event of any conflict between a provision of this Act and a provision of any other law for the time being in force, the provision of this Act shall prevail to the extent of such conflict.`,
    },
    {
      ...
      chapterNumber: 9,
      chapterTitle: "Miscellaneous",
      officialText: `No civil court shall have the jurisdiction to entertain any suit or proceeding in respect of any matter for which the Board is empowered under the provisions of this Act and no injunction shall be granted by any court or other authority in respect of any action taken or to be taken in pursuance of any power under the provisions of this Act.`,
    },
    {
      sectionNumber: 40,
      slug: "section-40",
      ...
      chapterNumber: 9,
      chapterTitle: "Miscellaneous",
      officialText: `(1) The Central Government may, by notification, and subject to the condition of previous publication, make rules not inconsistent with the provisions of this Act, to carry out the purposes of this Act.
...
(2) In particular and without prejudice to the generality of the foregoing power, such rules may provide for all or any of the following matters, namely:—
    ...
    },
    {
      ...
      chapterNumber: 9,
      chapterTitle: "Miscellaneous",
      officialText: `(1) The Central Government may, by notification, amend the Schedule, subject to the restriction that no such notification shall have the effect of increasing any penalty specified therein to more than twice of what was specified in it when this Act was originally enacted.
...
(3) Every order made under this section shall be laid, as soon as may be after it is made, before each House of Parliament.`,
    },
    {
      ...
      chapterNumber: 9,
      chapterTitle: "Miscellaneous",
      officialText: `(1) In section 14 of the Telecom Regulatory Authority of India Act, 1997, in clause (c), for sub-clauses (i) and (ii), the following sub-clauses shall be substituted, namely:—
...
export const scheduleRows: ScheduleRow[] = [
  {
    ...
    penalty: "May extend to two hundred and fifty crore rupees (₹250 crore).",
  },
  {
    serialNumber: 2,
    breach:
    ...
    penalty: "May extend to two hundred crore rupees (₹200 crore).",
  },
  {
    serialNumber: 3,
    breach:
  ...
  },
  {
    ...
    penalty: "May extend to one hundred and fifty crore rupees (₹150 crore).",
  },
  {
    serialNumber: 5,
    breach: "Breach of the duties under section 15.",
    penalty: "May extend to ten thousand rupees (₹10,000).",
  },
  {
    serialNumber: 6,
    breach:
  ...
  },
  {
    ...
    penalty: "May extend to fifty crore rupees (₹50 crore).",
  },
];

// ─── MASTER EXPORT ───────────────────────────────────────────────────────────

export const dpdpAct2023 = {
  title: "Digital Personal Data Protection Act, 2023",
  actNumber: "No. 22 of 2023",
  assentDate: "11th August, 2023",
  source: "Gazette of India Extraordinary, Part II — Section 1",
  lastVerified: "April 2026",
  chapters: [chapter1, chapter2, chapter3, chapter4, chapter5, chapter6, chapter7, chapter8, chapter9],
  schedule: {
    title: "The Schedule",
    reference: "[See section 33(1)]",
    rows: scheduleRows,
  },
};

// Helper: flat list of all sections for TOC and search
export const allSections: ActSection[] = dpdpAct2023.chapters.flatMap(
  (ch) => ch.sections
);
